...
/*
    <div id="source">
        <br>
        <div>SOURCE:</div>
        <input type="radio" name="source_check" value="None" onchange="radio_button_function(value)" /> None
        <input type="radio" name="source_check" value="Mensura" onchange="radio_button_function(value)" /> Mensura
        <input type="radio" name="source_check" value="Link" onchange="radio_button_function(value)" /> Link
        <br>
        <div id="custom_source">
